...
// ------------------------------
// 2. Procesar preguntas al formato final
// ------------------------------
...
async function main() {
  console.log("Iniciando exercici 1...");
  ...
  console.log("Preguntas seleccionadas:", topPreguntas.length);

  const preguntasProcesadas = processQuestionsData(topPreguntas);

  console.log("Ejemplo de pregunta procesada:");
  console.log(preguntasProcesadas[0]);
